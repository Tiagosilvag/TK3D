...
export function AppLayoutClient({
  ...
  return (
    <div className="tk-gradient-bg flex h-screen overflow-hidden">
      <aside className="flex w-60 shrink-0 flex-col border-r border-slate-300 bg-violet-50/60 shadow-[2px_0_10px_-2px_rgba(15,23,42,0.10)] dark:border-slate-800 dark:bg-slate-900 dark:shadow-none">
